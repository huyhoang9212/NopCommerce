...
namespace Nop.Services.News
{
    ...
    public partial interface INewsService
    {
        ...
        IPagedList<NewsItem> GetAllNews(int languageId = 0, int categoryId = 0 , int storeId = 0,
    ...
    public partial interface INewsCategoryService
    {
        ...
        /// <param name="customerId">Customer identifier; 0 to load all records</param>
        /// <returns>Comments</returns>
        IList<NewsItem> GetAllNewsByCategory(int categoryId);

        IList<NewsCategory> GetAllNewsCategoryByParentId(int parentNewsCategoryId);
    }
}
